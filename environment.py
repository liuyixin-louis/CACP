...
class CACPWrapperEnvironment(gym.Env):
    ...
    def _collect_fm_reconstruction_samples(self, modules_list):
        ...
        from pruning.ranked_structures_pruner import FMReconstructionChannelPruner
    ...
    def _log_model_info(self):
        ...
        msglogger.debug("\tTotal MACs: %s" % utils.pretty_int(self.original_model_macs))
    ...
    def finalize_episode(self, reward, val_results, total_macs, total_nnz,
        ...
        if log_stats:
            ...
            utils.log_training_progress(stats, None, self.episode, steps_completed=0, total_steps=1,
